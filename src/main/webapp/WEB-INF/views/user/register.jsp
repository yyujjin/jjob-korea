    ...
    <body>
        ...
        <div id="individualForm" class="container02">
            <form id="signup-form" method="post" action="/register">
                ...
                <div class="form-group">
                    <input type="password" id="password" name="password" placeholder="비밀번호(8-16자 영문, 숫자, 특수문자)"
                        required>
                ...
                <div class="form-group">
                    <input type="text" id="individualBirthd" id="birthd" name="birthd" placeholder="생년월일(예시:20000131)"
        ...
        <div id="enterpriseForm" class="container02" style="display: none;">
            <form id="signup-form" method="post" action="/register">
                ...
                <div class="contactPerson">
                    ...
                    <div class="form-group">
                        <input type="text" id="enterpriseBirthd" name="birthd" placeholder="생년월일(예시:20000131)"
