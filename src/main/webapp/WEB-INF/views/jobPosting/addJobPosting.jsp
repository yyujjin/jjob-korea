...
<body>
    <div class="addPosting">
        ...
        <form action="/jobPost/create" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="jobPostingUploadPath">회사 이미지</label>
                <input type="file" id="jobPostingUploadPath" name="jobPostingUploadPath" class="form-control-file">
            </div>

            <div class="form-group">
                <label for="postingdetails">상세 정보</label>
                <textarea id="postingdetails" name="postingdetails" rows="5" class="form-control" placeholder="상세 정보를 입력하세요"></textarea>
            </div>
