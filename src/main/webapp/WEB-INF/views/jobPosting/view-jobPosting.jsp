...
<body>
    <!-- Form is only for validation or other purposes, but not for file upload -->
    <form method="get" action="/jobPosting" enctype="multipart/form-data" onsubmit="return validateForm();">
                ...
                <div class="card job-info">
                    <div class="card-body">
                        ...
                        <div class="logo-section text-center">
                            <c:choose>
                                <c:when test="${jobPosting.jobPostingFilePath == null || jobPosting.jobPostingFilePath.isEmpty()}">
